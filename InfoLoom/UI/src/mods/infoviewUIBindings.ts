...
export const elementaryStudentCount$: ValueBinding<number> = bindValue<number>(
  'InfoLoomTwo',
  'elementaryStudentCount',
  0
);
export const highSchoolStudentCount$: ValueBinding<number> = bindValue<number>(
  'InfoLoomTwo',
...
export const universityStudentCount$: ValueBinding<number> = bindValue<number>(
  'InfoLoomTwo',
...
//Indicator Values
export const elementaryAvailability$: ValueBinding<IndicatorValue> = bindValue<IndicatorValue>(
  'InfoLoomTwo',
  'elementaryAvailability'
);
export const highSchoolAvailability$: ValueBinding<IndicatorValue> = bindValue<IndicatorValue>(
  'InfoLoomTwo',
  'highSchoolAvailability'
);
export const collegeAvailability$: ValueBinding<IndicatorValue> = bindValue<IndicatorValue>(
  'InfoLoomTwo',
  'collegeAvailability'
);
export const universityAvailability$: ValueBinding<IndicatorValue> = bindValue<IndicatorValue>(
  'InfoLoomTwo',
