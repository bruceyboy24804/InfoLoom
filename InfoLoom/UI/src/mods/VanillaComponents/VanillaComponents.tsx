...
export class VanillaComponentResolver {
    ...
    public get colorFieldTheme(): Theme | any {
        return this.cachedData["colorFieldTheme"] ?? this.updateCache("colorFieldTheme");
    }
