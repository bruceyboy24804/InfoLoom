    ...
    <div className={styles.buildingUseInfomodeCheckBoxContainer} onClick={() => onCheckBoxClick()}>
      <div
        className={joinClasses(
          ModuleResolver.instance.CheckboxClasses.toggle,
      ...
      >
        <div
          className={joinClasses(ModuleResolver.instance.CheckboxClasses.checkmark, isChecked ? 'checked' : '')}
        ></div>
      </div>
      <div className={styles.buildingUseInfomodeCheckBoxLabel}>{label}</div>
    </div>
  );
};
