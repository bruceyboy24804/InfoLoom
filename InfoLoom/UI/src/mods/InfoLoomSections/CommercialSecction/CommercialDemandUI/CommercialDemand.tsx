...
const RowWithThreeColumns: FC<RowWithThreeColumnsProps> = ({
  left,
  leftSmall,
  right1,
  flag1,
...
const ColumnCommercialData: FC<ColumnCommercialDataProps> = ({ data }) => {
  return (
    <div style={{ width: '70%', boxSizing: 'border-box', border: '1px solid gray' }}>
      ...
      <RowWithThreeColumns
        left="SERVICE UTILIZATION"
        leftSmall="30% is the neutral ratio"
        right1={data[3]}
        flag1={data[3] < 30}
        right2={data[4]}
        flag2={data[4] < 30}
      />
      <RowWithThreeColumns
        left="PRODUCTION CAPACITY"
        leftSmall="100% when production capacity = resources needs"
        right1={data[5]}
        flag1={data[5] > 100}
        right2={data[6]}
        flag2={data[6] > 100}
      ...
      <RowWithThreeColumns
        ...
        leftSmall="75% is the neutral ratio"
        right1={data[7] / 10}
        flag1={data[7] < 750}
      />
