...
const formatProfitabilityWithColor = (profitabilityValue: number): JSX.Element => {
    ...
    let color = 'inherit';
    if (percentage > 10) color = '#4CAF50';      // Green for good profit
    else if (percentage > 0) color = '#8BC34A';  // Light green for small profit
    else if (percentage < -10) color = '#F44336'; // Red for significant loss
