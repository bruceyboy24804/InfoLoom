...
namespace InfoLoomTwo.Domain.DataDomain
{
    ...
    public struct PopulationDetailedGroupInfo : IJsonWritable
    {
		...
		public PopulationDetailedGroupInfo(int age)
		{
			Age = age;
			Total = 0;
			Work = 0;
		...
		{
			writer.TypeBegin(typeof(PopulationDetailedGroupInfo).FullName);
