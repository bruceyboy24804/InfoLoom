...
{
    public struct PopulationTenYearGroupInfo : IJsonWritable
    {
         ...
         public PopulationTenYearGroupInfo(int age)
         {
             Age = age;
             Total = 0;
             Work = 0;
         ...
         {
             writer.TypeBegin(typeof(PopulationTenYearGroupInfo).FullName);
